...
export const PRODUCTS_DATA: Product[] = [
  ...
  },
  {
    ...
    description: "Irish Orange is a mild, citrus-based cleaning solution suitable for wiping down various surfaces in the interior of an auto, truck or SUV. Citrus 41 is a polish safe non-caustic formula with a nice sudsy blend for cars & trucks, motorcycles to big rigs.",
    imageUrl: "/images/irishorange_citruswashlabel.jpg",
    price: "Contact for pricing",
    fullScribe: "It works well as a shampoo for all rugs and carpets in the floorboard of your vehicles. It can also be used to wash exterior painted or polished surfaces with excellent results. Also available as Citrus 113 Light Duty Truck Wash and Citrus 212 Medium Duty Truck Wash. This product is free rinsing and will not cause any issues with dulling the luster of the surface being washed.",
  ...
  },
  {
    ...
    guarantee: "Satisfaction Guaranteed, manufacturer’s liability is limited to refund of purchase price when unused. Proof of Purchase is required and must be returned within 30 days. This product will assist with providing a lustrous finish."
  },
  {
    id: "5",
